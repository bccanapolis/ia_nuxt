...
export const members = [{
  ...
  socials: [{url: 'http://lattes.cnpq.br/6278694958208888', type: 'lattes'}, {
    url: '',
    type: 'linkedin'
  ...
  socials: [{url: 'http://lattes.cnpq.br/4603724338719739', type: 'lattes'}, {
    url: '',
    type: 'linkedin'
  }, {url: 'daniel.sousa@ifg.edu.br', type: 'envelope'},],
}, {
  degree: 'Dr.',
  name: 'Daywes Pinheiro Neto',
  photo: '/img/member/daywes.jpeg',
  disciplines: ['Energias Renováveis', 'Otimização Aplicada'],
  socials: [{url: 'http://lattes.cnpq.br/3885723899789699', type: 'lattes'}, {
    url: '',
    type: 'linkedin'
  }, {url: 'daywes.neto@ifg.edu.br', type: 'envelope'},],
},

  {
    ...
    disciplines: ['Pecuária de Precisão (Pecuária 4.0)', 'Search Based Software Engineering (SBSE)',],
    socials: [{url: 'http://lattes.cnpq.br/8639235593693663', type: 'lattes'}, {
      url: 'eduardo-noronha-45616125',
      type: 'linkedin'
    ...
    socials: [{url: 'http://lattes.cnpq.br/1543798708473666', type: 'lattes'}, {
      url: 'gustavo-de-assis-costa-20733347',
      type: 'linkedin'
    ...
    socials: [{url: 'http://lattes.cnpq.br/8575752368239596', type: 'lattes'}, {
      url: 'katia.fernandes@ifg.edu.br',
      type: 'envelope'
    },],
  }, {
    degree: 'Dr.',
    name: 'Lucas de Almeida Ribeiro',
    photo: '/img/member/lucas-almeida.jpeg',
    disciplines: ['Aprendizado de Máquina', 'Inteligência de Negócios'],
    socials: [{url: 'http://lattes.cnpq.br/1560906170071960', type: 'lattes'}, {
      url: 'lucas.ribeiro@ifg.edu.br',
      type: 'envelope'
    },],
  }, // {
  //   degree: 'Msc.',
  //   name: 'Roney Lopes Lima',
  //   // photo: '/img/member/lucas-almeida.jpeg',
  //   disciplines: ['Sistemas de Computação'],
  //   socials: [
  //     {url: 'http://lattes.cnpq.br/3406246380949411', type: 'lattes'},
  //     {url: 'roney.lima@ifg.edu.br', type: 'envelope'},
  //   ],
  // },
  {
    degree: 'Msc.',
    name: 'Eder Silva de Brito ',
    photo: '/img/member/eder.jpeg',
    disciplines: ['Estatística Aplicada'],
    socials: [{url: 'http://lattes.cnpq.br/0791900403733039', type: 'lattes'}, {
      url: 'eder.brito@ifg.edu.br',
      type: 'envelope'
    },],
  }, // {
  ...
  // },
  {
    ...
    socials: [{url: 'http://lattes.cnpq.br/4136576326278536', type: 'lattes'}, {
      url: 'gomesra',
      type: 'linkedin'
    ...
    disciplines: ['Recuperação de Informação', 'Aprendizado de Máquina'],
    socials: [{url: 'http://lattes.cnpq.br/5172447060300953', type: 'lattes'}, {
      url: '',
      type: 'linkedin'
    ...
    socials: [{url: '', type: 'lattes'}, {
      url: 'https://www.linkedin.com/in/leandro-alexandre-57aa0b195', type: 'linkedin',
    }, {url: '', type: 'envelope'},],
  }, {
    degree: 'Msc.',
    name: 'Renan Oliveira',
    photo: '/img/member/renan_oliveira.jpeg',
    disciplines: ['Recuperação de Informação', 'Inteligência Artificial Aplicada',],
    socials: [{url: '', type: 'lattes'}, {
      url: 'https://www.linkedin.com/in/renan-oliveira-22761919/', type: 'linkedin',
    }, {url: '', type: 'envelope'},],
  }, {
    degree: 'Dr.',
    name: 'Daniel Canedo',
    ...
    socials: [{url: 'http://lattes.cnpq.br/9765585618707211', type: 'lattes'}, {url: '', type: 'lattes'}, {
      url: '',
      type: 'lattes'
    },],
  }, // {
